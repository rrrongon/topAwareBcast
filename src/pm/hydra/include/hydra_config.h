...
/* Configure arguments */
#define HYDRA_CONFIGURE_ARGS_CLEAN "'--disable-option-checking' '--prefix=/jet/home/rongon/mpi/mvapich/mvapich_installation' '--cache-file=/dev/null' '--srcdir=.' 'CC=gcc' 'CFLAGS= -DNDEBUG -DNVALGRIND -O2' 'LDFLAGS=-L/lib -L/lib -L/lib -Wl,-rpath,/lib -L/lib -Wl,-rpath,/lib -L/lib -L/lib' 'LIBS=-libmad -lrdmacm -libumad -libverbs -ldl -lrt -lm -lpthread ' 'CPPFLAGS= -I/jet/home/rongon/mpi/mvapich/mvapich2-2.3.2/src/mpl/include -I/jet/home/rongon/mpi/mvapich/mvapich2-2.3.2/src/mpl/include -I/jet/home/rongon/mpi/mvapich/mvapich2-2.3.2/src/openpa/src -I/jet/home/rongon/mpi/mvapich/mvapich2-2.3.2/src/openpa/src -D_REENTRANT -I/jet/home/rongon/mpi/mvapich/mvapich2-2.3.2/src/mpi/romio/include -I/include -I/include -I/include -I/include' 'MPLLIBNAME=mpl'"
